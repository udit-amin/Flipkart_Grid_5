...
def checkpoint1_find_rotation_angle(image_path):
    # Read the image
    ...
    # Calculate the angle between the horizontal line and the longest side
    angle_difference = abs(angle_with_x_axis - 90)
    ...
    return angle_with_x_axis, angle_difference

# Use 'box.jpg' as the image file
image_path = 'box.jpg'
angle_with_x_axis, angle_difference = checkpoint1_find_rotation_angle(image_path)
print(f"Angle with x-axis of the longest side: {angle_with_x_axis} degrees")
print(f"Angle difference with horizontal line: {angle_difference} degrees")
